<script> 
    ...
    let question = 'What decimal is 5/6'
    let page_url = 'what-decimal-is-5:6'
    let type_of_question = 'decimal'
    let meta_description = "What decimal is 5/6? Learn how to convert 5/6 into a decimal and earn a money reward if you can solve this question correctly."
    let page_thumbnail = "#"
	
	let answer_tip = "Limit your answer to four decimal places, for example 0.1111"
	...
	let step_1 = "To convert 5/6 into a decimal, we need to divide the numerator (5) by the denominator (6)."
	let step_2 = "To divide 5 by 6, we start by writing 8 as the first digit after the decimal point."
	let step_3 = "Our final answer is 0.83333..., with the 3s repeating forever. This is the decimal representation of 5/6."
