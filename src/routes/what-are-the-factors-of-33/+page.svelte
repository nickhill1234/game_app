<script> 
    ...
    let meta_description = "Solve this problem and unlock a money reward. Learn how to find the factors of 33 by creating a list of the factors and using the prime factors method."
    let page_thumbnail = "#"

    let app_name = 'Math for Money'
    let about_url = 'mathformoney.app/about'
    let math_worksheets_url = 'mathformoney.app/math-worksheets'
    let resources_url = 'mathformoney.app/about'
    let social_impact_url = 'mathformoney.app/social-impact'
    let contract_url = 'mathformoney.app/contract'
	...
	<head>
		...
		<link rel="icon" href="../../static/logo-dark.png" />
						...
						<div class="column width-12 nav-bar-inner">
							<div class="logo">
								<div class="logo-inner">
									<a href="index"><let src ="./static/logo-dark.png" alt="Pocketjam Logo" /></a>
									<a href="index"><let src ="./static/logo.png" alt="Pocketjam Logo" /></a>
								</div>
							</div>
			...
			<div class="content clearfix">
				...
				<div class="section-block pt-0 pb-0">
					<div class="row">
						...
						<div class="column width-12">
							<h3 class="mb-50">Need help? Find more information on the links below.</h3>
						</div>
					</div>
					<div class="row">
						<div class="column width-12">
							<div class="accordion mb-50">
								<ul>
									<li class="inactive">
										<a href="#accordion-1-panel-1">Click for some hints to help you solve the question</a>
										<div id="accordion-1-panel-1">
											<div class="accordion-content">
												<p class="lead mb-20">The best way to think about factoring a number is like taking a puzzle apart and finding the smaller parts that make up the bigger number.
												<br><br>
									...
									<li>
										<a href="#accordion-1-panel-2">Click here for a step by step guide to work through the first factors</a>
										<div id="accordion-1-panel-2">
											<div class="accordion-content">
												<p class="lead mb-20">To factorize the number 33, we are going to find all the numbers that multiply together to make 33. These numbers are called "factors" of 33.
													<br><br>
